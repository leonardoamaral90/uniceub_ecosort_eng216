...
- **Mais leve localmente:** o Airflow exige banco de dados (PostgreSQL/SQLite), scheduler, webserver e worker rodando como processos separados; o Prefect sobe com um único processo, reduzindo o consumo de recursos da máquina — importante dado que a stack já inclui Kafka, Spark, MinIO e Metabase
